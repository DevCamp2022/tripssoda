...
<%--        </div>--%>
        <div class="review-wrap">
            ...
            <div class="th-wrap">
                ...
                <div class="th-product-id">상품 번호</div>
            ...
            <div class="paging">
                ...
                <c:if test="${totalCnt!=null && totalCnt!=0}">
                    ...
                    <c:if test="${ph.showNext}">
                        <a class="page" href="<c:url value="/mypage/tourReviewList${ph.sc.getQueryString(ph.endPage+1)}"/>"><i class="fa-solid fa-circle-arrow-right"></i></a>
                    </c:if>
                </c:if>
            </div>
        </div>
